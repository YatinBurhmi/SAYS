        ...
        <div class="col-md-4 col-md-offset-4">  
            <div class="login-panel panel panel-success">  
                <div class="panel-heading">  
                    <h3 class="panel-title" style="color:#f9ad81">ENTER ONE TIME PASSWORD</h3>  
                </div>  
                <div class="panel-body">  
                    <form name="enquiry" action="otp_check.php" method="POST" enctype="multipart/form-data">
    <?php
     if(!isset($_SESSION)) 
    { 
        session_start(); 
...
Enter otp sent to your mobile number:<br>
    <input name="otp" type="text" value="" size="30" required placeholder="OTP" style="width:250px; resize:none;
    padding: 12px 20px;
    margin: 8px 0;
     display: block;
    margin-left: auto;
    ...
    <input type="submit" value="SUBMIT" name="otp_submit" style="
